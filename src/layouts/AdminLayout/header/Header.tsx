    ...
    <>
      <div className="bg-slate-900 p-4 px-8 flex items-center space-x-5 text-gray-200">
        <Icon
          ...
          fontSize={32}
        />
        <div className="h-10 w-[50%] relative border-[1px] focus-within:border-solid focus-within:border-gray-400 rounded-lg">
          <Icon
            icon={'material-symbols:search'}
            fontSize={32}
            className="absolute top-1.5 ml-2 text-gray-500"
          />
          <input
            type="text"
            placeholder="Search..."
            className="h-full w-full outline-none pl-12 rounded-lg shadow-md text-gray-500 "
          />
        </div>
        ...
        <div className="flex-1 flex justify-end ">
          <div className="space-x-5 flex items-center">
            ...
            {!isShow && (
              <div className="absolute top-14 right-5 z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600 ">
                ...
                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200 ">
                  <li>
                    <button className="text-start w-full block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                      Dashboard
                    </button>
                  </li>
                  <li>
                ...
                <div className="py-2">
                  <button className="text-start w-full block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                    Sign out
                  </button>
                </div>
              </div>
