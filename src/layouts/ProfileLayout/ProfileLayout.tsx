    ...
    <>
      ...
      <main className="bg-[#f0f0f0] py-5 block h-screen">
        <div className="lg:container w-full mx-auto flex box-border ">
          <div className="min-w-[250px] shadow-lg border-[#e8e8e8] max-h-[350px] bg-white rounded-md">
            <h1 className="text-center text-xl font-bold uppercase text-[#C92127] py-5">Tài khoản</h1>
            <hr />
            <ul className="divide-y pb-9">
              ...
              <li>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? 'flex items-center px-5 py-3 text-[#1435cd] font-semibold w-full border-b'
                      : 'flex items-center px-5 py-3 hover:text-[#1435cd] hover:bg-[#f5f5f5] w-full border-b'
                  }
                >
                  <Icon
